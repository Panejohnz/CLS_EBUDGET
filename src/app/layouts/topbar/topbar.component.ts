...
export class TopbarComponent implements OnInit {
  ...
  public yearChange$ = this.yearChangeSubject.asObservable();
  ...
  ngOnInit(): void {
    ...
    if (storedYear) {
      ...
      // ถ้าไม่มีค่าให้ set ค่า default เป็นปีปัจจุบัน (พ.ศ.) แต่ถ้าเกินเดือน 9 ให้ปี +1
    ...
    // ใช้ setTimeout เพื่อให้แน่ใจว่า sidebar subscribe แล้ว
    setTimeout(() => {
