...
export class Report_R004Component implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.rawReportUrl = 'https://app.celestsoft.com/CLS_ERP_BUDGET_REPORT/Report/Budget_Report_R004.aspx?token=' + this.token;
