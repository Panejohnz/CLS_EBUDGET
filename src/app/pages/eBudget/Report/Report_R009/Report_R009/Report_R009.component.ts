...
export class Report_R009Component implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.rawReportUrl = 'https://app.celestsoft.com/CLS_ERP_BUDGET_REPORT_DEMO/Report/Budget_Report_R009.aspx?token=' + this.token;
